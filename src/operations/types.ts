...
export interface OperationsStatistics { readonly boardings: number; readonly alightings: number; readonly deniedBoardings: number; readonly unservedDemand: number; readonly totalWaitSeconds: number; readonly maximumWaitSeconds: number; readonly operatingVehicleSeconds: number; readonly completedTrips: number; readonly byLine: Readonly<Record<string, { readonly boardings: number; readonly alightings: number; readonly totalWaitSeconds?: number }>>; }
