...
export type TravelRequestStatus = 'unresolved' | 'assumedAlternativeMode' | 'inTransit' | 'completed' | 'unserved';
...
export interface PopulationSummary {
  ...
  readonly requestingRoute: number;
  readonly traveling: number;
  readonly atDestination: number;
  readonly activeRequests: number;
  readonly returnTripsPending: number;
  readonly servedTrips: number;
  readonly unservedTrips: number;
}
