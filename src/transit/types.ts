...
export interface TransitLine { readonly id: string; readonly name: string; readonly mode: TransitMode; readonly stopIds: readonly string[]; readonly segments: readonly TransitSegment[]; readonly direction: 'bidirectional' | 'one-way'; readonly active: boolean; readonly visible?: boolean; readonly color?: string; readonly farePolicyId?: string; readonly serviceSettings?: { readonly plannedHeadwayMinutes?: number }; }
