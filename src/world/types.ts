...
export interface Road { readonly id: string; readonly name?: string; readonly geometry: readonly Coordinate[]; readonly classification: RoadClass; readonly speedKph?: number; }
...
export interface Waterway { readonly id: string; readonly geometry: readonly Coordinate[]; readonly kind: 'river' | 'lake' | 'canal'; }
