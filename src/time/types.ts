...
export interface SimulationEngineState { readonly version: 1; readonly timestampSeconds: number; readonly speed: SimulationSpeed; readonly scheduledEvents: readonly ScheduledEvent[]; readonly operationsServices?: readonly import('../operations').LineServiceConfiguration[]; }
